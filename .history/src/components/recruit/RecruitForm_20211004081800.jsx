    ...
    <div className="container-fluid" id="recruit">
      ...
      <Row className="mt-2">
        <Col className=" mb-2 ms-auto text-center">
          <img src={Left} alt="we are recruiting ridersx" />
        </Col>
        <Col className="me-auto ">
          <Row>
            <Col className="vaccancy"><h3>Are you energetic, open-minded, customer friendly with a wide knowledge of lagos netwrork?</h3></Col>
            <Col>2</Col>
          </Row>
