...
const recruitForm = () => {
  return (
    <div className="container-fluid" id="recruit">
      ...
      <Row className="mt-2">
        <Col className="loading mb-2 ms-auto text-center">
          <img src={Left} alt="we are recruiting riders" />
        </Col>
        <Col className="ms-auto me-auto" id="vaccancy">
          <h3>
            Are you energetic, open-minded, customer friendly with a wide
            knowledge of lagos road network?
          </h3> <br />
          <h3>
            if you have what it takes in working with our team, contact us by filling the form below
          </h3>
